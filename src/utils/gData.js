...
export const gData = [
    {
                ...
                "taskgroups": [
                    {
                        ...
                        "tasks": [
                            {
                                "guid": "027f37ab9b548flih54316f",
                                "title": "Huolten polttaminen t1"
                            },
                            {
                                "guid": "027f37ab9sdzvd62a6d654316f",
                                "title": "Huolten polttaminen t2"
                            }
                        ],
                        "mandatory_tasks": "",
                        "guid": "2785ba72d5bb598808f7ede5770b9803",
                        "title": "Hengellisyys",
        ...
        "tasks": [],
        "guid": "5f6c4cefac801370cd255dd36e6dacbf",
        "title": "Paussit",
        "order": 0
    },
    {
        "taskgroups": [
            {
                ...
                "tasks": [
                    {
                        "guid": "027f37ab9b548f0a81b062a6d654316f",
                        "title": "Huolten polttaminen toine ryhmä 1"
                    }
                ],
                "mandatory_tasks": "",
                "guid": "2785ba72sdv98808f7ede5770b9803",
                "title": "Huolten polttaminen toine ryhmä 2"
...
export function generateData(x = 4, y = 3, z = 2, gData = []) {
